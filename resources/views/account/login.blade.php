        ...
        <div class="card-body">
            ...
            <form action="{{ route('account.login') }}" method="POST" class="space-y-4">
                ...
                <div class="form-control w-full">
                    ...
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter your email" class="input input-bordered w-full" required />
                </div>
            ...
            <div class="text-center">
                <p class="text-sm">No account yet? <a href="{{ route('account.create') }}" class="link link-primary font-semibold">Sign up here</a></p>
            </div>
        </div>
    </div>
</div>
