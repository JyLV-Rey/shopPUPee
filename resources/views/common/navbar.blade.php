    ...
    <div class="navbar-start">
        <a class="btn btn-ghost" href="/">
            <div class="flex items-center gap-2">
                ...
                <span class="hidden sm:inline font-bold text-lg">shopPUPee</span>
            </div>
        </a>
    </div>

    <div class="navbar-center hidden lg:flex">
        <form method="GET" action="{{ route('search') }}" class="contents">
            <label class="input">
                ...
                <input type="search" name="searchTerm" class="grow" placeholder="Search"
