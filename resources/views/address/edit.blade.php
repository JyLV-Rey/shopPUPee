...
<div class="max-w-2xl mx-auto px-4 py-10">
  ...
  <div class="card bg-base-100 shadow-lg border border-base-200">
    <div class="card-body">
      <h1 class="card-title text-2xl mb-1">Edit Address</h1>
      <p class="text-base-content/60 text-sm mb-6">Update the address details below.</p>

      <form method="POST" action="{{ route('edit.address', ['addressId' => $address->address_id]) }}">
        @csrf
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div class="form-control">
            ...
            <input
              ...
              id="unit_floor"
              name="unit_floor"
              value="{{ old('unit_floor', $address->unit_floor) }}"
              class="input input-bordered w-full"
              placeholder="Optional"
            />
          </div>
          ...
          <div class="form-control sm:col-span-2">
            ...
            >{{ old('additional_notes', $address->additional_notes) }}</textarea>
          </div>
        </div>
