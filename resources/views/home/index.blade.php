...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-16">
    ...
    <div class="text-center mb-12">
        <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-primary/70 text-primary-content shadow-lg mb-4">
        ...
        <p class="text-base-content/60 text-lg mt-2 max-w-lg mx-auto">Discover unique finds from campus sellers — all in one place.</p>
    </div>

    {{-- Search bar --}}
    <form method="GET" action="{{ route('search') }}" class="max-w-2xl mx-auto mb-12">
        <div class="join w-full shadow-md">
            <input type="search" name="searchTerm" placeholder="What are you looking for?" class="input input-bordered join-item flex-1" />
